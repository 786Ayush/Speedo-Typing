...
const Login = () => {
  ...
  return (
    <>
      {!lobby && <div className='h-full w-full'>
        <section className="dark:bg-slate-800">
          <div className="flex flex-col items-center justify-center px-6 py-8 mx-auto md:h-screen lg:py-0">
            <div className="w-full bg-white shadow dark:border md:mt-0 sm:max-w-md xl:p-0 dark:bg-slate-900 dark:border-gray-700 rounded-3xl">
